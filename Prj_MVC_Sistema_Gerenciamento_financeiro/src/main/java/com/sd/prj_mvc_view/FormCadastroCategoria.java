...
import com.sd.prj_mvc_controller.ControllerCadastroCategoria;
import com.sd.prj_mvc_model.objetos.Categorias;
import java.util.List;
import javax.swing.JOptionPane;

public class FormCadastroCategoria extends javax.swing.JFrame {

    private final ControllerCadastroCategoria controller;
    private int id;

    public FormCadastroCategoria(int id) {
        initComponents();
        controller = new ControllerCadastroCategoria();
    ...
    public void setTxtConsNome(String text) {
        if (txtConsNome != null) { // Verificação de segurança
    ...
    public String getTxtCodigo() {
     ...
     public void setTxtCodigo(String codigo) {
        if (txtCodigo != null) { // Verificação de segurança
            txtCodigo.setText(codigo);
        }
    }

    public void setTxtNome(String nome) {
        if (txtNome != null) { // Verificação de segurança
            txtNome.setText(nome);
        }
    }

    public void setBtnSalvarEnabled(boolean enabled) {
        if (btnSalvar != null) { // Verificação de segurança
            btnSalvar.setEnabled(enabled);
        }
    }

    public int getCmbCategoriasSelectedIndex() {
        return cmbCategorias.getSelectedIndex();
    }
