...
import com.sd.prj_mvc_controller.ControllerCadastroFornecedores;
import com.sd.prj_mvc_model.objetos.Categorias;
import java.util.List;
import javax.swing.JOptionPane;

public class FormCadastroFornecedores extends javax.swing.JFrame {

    private final ControllerCadastroFornecedores controller;
    private int id;

    public FormCadastroFornecedores(int id) {
        initComponents();
        controller = new ControllerCadastroFornecedores();
    ...
    public void setTxtConsNome(String text) {
        if (txtConsNome != null) { 
            txtConsNome.setText(text);
        }
    }

    public String getTxtConsNome() {
        return txtConsNome.getText();
    }
    ...
    public int getCmbFornecedoresSelectedIndex() {
        return cmbFornecedores.getSelectedIndex();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadastroFornecedores().setVisible(true);
            }
        });
    }
    ...
    public void preencherCombo(List<Categorias> lstCategorias) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void preencherCampos(Categorias categoria) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void mostrarMensagem(String dados_salvos_com_sucesso) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
